...
<meta charset="utf-8">
  ...
  <title>Buscar Pessoa Jurídica | IBeautySalon</title>
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header">
                ...
                <h4 class="modal-title">Buscar Pessoa Jurídica</h4>
              </div>
              <div class="modal-body">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" placeholder="Razão">
                </div>
                ...
                <div class="input-group">
                  ...
                  <input type="text" name="inscestadual" class="form-control" data-inputmask="'insc estadual'" data-mask>
                </div>
                <div class="form-group">
                <label>Fones</label>
                ...
                <div class="form-group">                
                 <label>Cep</label>
                <div class="input-group">
                <input type="text" class="form-control" data-inputmask='"mask": "(92) 99999-9999"' data-mask>                    <span class="input-group-btn">
                      <button type="button" class="btn btn-info btn-flat">Buscar</button>
                    </span>                                            
              </div>                                                  
              </div>
      ...
      <div class="box box-default">
        ...
        <!-- /.box-body -->        
              ...
              <div class="modal-footer">               
               <button type="button" class="btn btn-primary pull-left">Ativar Empresa</button>
