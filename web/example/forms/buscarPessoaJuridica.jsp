          ...
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-body">
                ...
                <input type="text" class="form-control" data-inputmask="00.000.000.0000-00" data-mask>                    <span class="input-group-btn">
                ...
                <div class="input-group">
                  <div class="input-group-addon">
                    ...
                    <input type="text" class="form-control" disabled="disabled" data-inputmask='"mask": "(92) 99999-9999"' data-mask>
      ...
      <div class="box box-default">
          ...
          <div class="row">
            <div class="col-md-6">              
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" disabled="disabled" placeholder="Ponto de Referência">
              </div>
              
              <div class="form-group">
                <label>Número</label>
                <input type="text" class="form-control" disabled="disabled" placeholder="N°">
              </div>
              <!-- /.form-group -->
            </div>
            <!-- /.col -->
        ...
        <!-- /.box-body -->        
                 ...
                 <div class="form-group">
                  ...
                  <input type="email" class="form-control" disabled="disabled   " id="exampleInputEmail1" placeholder="Email">
                </div>
                 <div class="form-group">
                <label>Status</label>
