...
<li class="active treeview">
          ...
          <ul class="treeview-menu">
              <li class="active"><a href="index.jsp"><i class="fa fa-circle-o"></i> MenuPrincipal</a></li>           
          </ul>
        </li>
    <li class="treeview">
          <a href="#">
        ...
        <li class="treeview">
          <a href="#">
            ...
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>            </span>          </a>
          <ul class="treeview-menu">
              <li><a href="example/forms/cadClienteFisica.jsp" target="mainFrame" ><i class="fa fa-circle-o"></i> Alterar Cliente</a></li>                           
          </ul>          
        </li>
        <li class="treeview">
          <a href="#">
