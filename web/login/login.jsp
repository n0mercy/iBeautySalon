                                    ...
                                    <body class="hold-transition login-page">
                                        <div class="login-box">
                                            ...
                                            <div class="login-box-body">
                                                ...
                                                <form data-toggle="validator" action="../ControllerLogin" method="post">
                                                    <div class="form-group has-feedback">
                                                        <input required type="email" name="login" id="login" class="form-control" placeholder="Email" />
                                                        <span class="glyphicon glyphicon-envelope form-control-feedback"></span>
                                                    </div>
                                                    <div class="form-group has-feedback">
                                                        <input required data-error="Mínimo de 6 caracteres" data-minlength="6" type="password" name="pwd" id="pwd" class="form-control" placeholder="Senha"/>
